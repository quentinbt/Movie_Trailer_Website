...
#insertion of the titles, resume, image and trailer of my avorites movies using the class Movie from the file media
toy_story = media.Movie("Toy Story",
                        "A story of a boy and his toy who fuck each other",
                        "http://upload.wikimedia.org/wikipedia/en/1/13/Toy_Story.jpg",
                        "https://www.youtube.com/watch?v=vwyZH85NQC4")


avatar = media.Movie("Avatar",
                     "A maine on a alien planet",
...
#launch the function open_movies_page with the list of my favorites movies in it
